...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset_name", default='qm7', choices=['esol', 'freesolv', 'lipophilicity','qm8','esol','qm7','qm9'])
    ...
    parser.add_argument("--init_model", type=str, default='pretrain_models/ene/epoch23.pdparams')  # GEM_pretrain_models/zinc_lr0001_bs512/epoch45.pdparams
